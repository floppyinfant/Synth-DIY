...
void DeviceMIDI::handleControlChange(byte channel, byte number, byte value) {
	...
	case 100:
		// volume
		static int vol = map(value, 0, 127, 0., 1.);  // TODO: use global variable
		break;
	default:
		break;
	}
...
void DeviceMIDI::handlePitchBend(byte channel, int bend) {
	...
	// @see https://github.com/sparkfun/MIDI_Shield/tree/V_1.5/Firmware/MIDI-CV
	// Bend data from the parser is 14 bits, signed, centered on 0.
	// unsigned conversion & dual-7-bit thwacking 
	// already handled by midi parser
	static int16_t last_bend = bend >> 5;  // TODO: use global variable
}
